...
server.get('/api/listings', async (req, res) => {
  try {
    ...
    const { city, country, checkIn, checkOut, guests, page = 1, limit = 20 } = req.query;
    let filter = {};
    ...
    // Availability filter - for now, simple check if property is available
    // In a real app, you'd check against booked dates
